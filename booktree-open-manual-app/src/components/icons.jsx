...
const RAW_ICONS = {
  ...
  Back: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.4" strokeLinecap="round" strokeLinejoin="round"><path d="m15 18-6-6 6-6"/></svg>,
  ...
  Doc: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>,
  ...
  Alert: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><line x1="12" y1="9" x2="12" y2="13"/><line x1="12" y1="17" x2="12.01" y2="17"/></svg>,
  ...
  Bookmark: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"/></svg>,
  ...
  Sparkle: (p) => <svg {...p} viewBox="0 0 24 24" fill="currentColor"><path d="M12 2l2.09 6.26L20 10l-6.26 2.09L12 22l-2.09-6.26L4 10l6.26-2.09z"/></svg>,
  Tree: (p) => <svg {...p} viewBox="0 0 64 64" fill="currentColor"><path d="M32 4c-2 4-5 6-8 8 3 0 5 1 8 2 3-1 5-2 8-2-3-2-6-4-8-8zm0 12c-3 4-7 6-11 8 4 0 8 1 11 3 3-2 7-3 11-3-4-2-8-4-11-8zm-2 12v20h4V28h-4z"/></svg>,
  ...
  Blog: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h9a5 5 0 0 1 0 10H4z"/><path d="M4 14h10a5 5 0 0 1 0 6H4z"/><line x1="4" y1="4" x2="4" y2="20"/></svg>,
  External: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>,
  ...
  Route: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="6" cy="19" r="3"/><path d="M9 19h8.5a3.5 3.5 0 0 0 0-7h-11a3.5 3.5 0 0 1 0-7H15"/><circle cx="18" cy="5" r="3"/></svg>,
  Megaphone: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m3 11 18-5v12L3 14v-3z"/><path d="M11.6 16.8a3 3 0 1 1-5.8-1.6"/></svg>,
  ...
  Coin: (p) => <svg {...p} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><path d="M15 9h-4.5a1.5 1.5 0 0 0 0 3h3a1.5 1.5 0 0 1 0 3H9"/><path d="M12 6v3M12 15v3"/></svg>,
...
// 책나무 로고 (심볼)
const BooktreeLogo = ({ size = 24, color = 'currentColor' }) => (
  <svg width={size} height={size} viewBox="0 0 64 64" fill="none">
    <g fill={color}>
      {/* 나무 새싹 심볼 - 책나무 스타일 */}
      <path d="M32 6 C30 10 27 12 24 14 C27 14 30 15 32 17 C34 15 37 14 40 14 C37 12 34 10 32 6 Z"/>
      <path d="M32 16 C28 22 22 25 16 27 C22 27 28 29 32 32 C36 29 42 27 48 27 C42 25 36 22 32 16 Z"/>
      <rect x="29" y="30" width="6" height="22" rx="1"/>
